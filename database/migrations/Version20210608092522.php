...
class Version20210608092522 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE group_product ADD CONSTRAINT FK_554A50A1987EFBE0 FOREIGN KEY (grtov_id) REFERENCES group_product (grtov) ON UPDATE NO ACTION ON DELETE NO ACTION');
