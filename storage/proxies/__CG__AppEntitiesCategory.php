...
class Category extends \App\Entities\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Category' . "\0" . 'attributeSetName', '' . "\0" . 'App\\Entities\\Category' . "\0" . 'attributeSetId'];
        }
    ...
    public function setAttributeSetName($attributeSetName = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttributeSetName', [$attributeSetName]);
